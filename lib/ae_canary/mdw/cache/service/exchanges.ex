          ...
          addrs =
            ...
            |> Enum.map(
              fn(a) ->
                ...
                suspicious_deposits = Transactions.list_locations_of_spend_txs_by(%{select: :tx_and_location, recipient_id: a.addr, date_from: update_start, amount_at_least: 1000})
