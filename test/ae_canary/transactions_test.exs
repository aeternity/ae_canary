defmodule AeCanary.TransactionsTest do
  ...
  describe "spend_txs" do
    ...
    @valid_attrs %{amount: 42, fee: 42, hash: "some hash", nonce: 42, recipient_id: "some recipient_id", sender_id: "some sender_id", block_hash: "some block_hash", keyblock_hash: "some keyblock_hash", block_height: 100, micro_time: "2010-04-17T14:00:00Z"}
    @update_attrs %{amount: 43, fee: 43, hash: "some updated hash", nonce: 43, recipient_id: "some updated recipient_id", sender_id: "some updated sender_id", block_hash: "some updated block_hash", keyblock_hash: "some updated keyblock_hash", block_height: 101, micro_time: "2011-05-18T15:01:01Z"}
    @invalid_attrs %{amount: nil, fee: nil, hash: nil, nonce: nil, recipient_id: nil, sender_id: nil, block_hash: nil, keyblock_hash: nil, block_height: nil, micro_time: nil}
